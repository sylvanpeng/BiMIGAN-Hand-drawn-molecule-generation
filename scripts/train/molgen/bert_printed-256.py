...
from bimigan.utils.parsers import add_preset_name_parser, add_batch_size_parser

def parse_cmdargs():
    parser = argparse.ArgumentParser(description = 'Train PrintedImage BERT')
...
# args
    ...
    'outdir'     : os.path.join(ROOT_OUTDIR, 'bert_printed'),
    'log_level'  : 'DEBUG',
    'checkpoint' : 10,
}
